...
### Phase 0: Clean Slate
Before anything else, delete all files in `handoffs/` and truncate `logs/audit.log` (keep both directories). This prevents stale data from a previous run leaking into the new project.
